...
const ChangePasswordIcon = (props) => {
  return (
    <svg {...props} fill="currentColor" height="200px" width="200px" version="1.1" id="Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" enable-background="new 0 0 24 24">
